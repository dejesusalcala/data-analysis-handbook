...
- Discuss at least three spreadsheet  data organization recomendations
- Describe what a data dictionary is ("metadata", "code book")
...
Most data in tabular form can be stored in **spreadsheets** (*.xls*, *x.lxs*), but it's best to store in a **text** file (*.txt*, *.csv*, etc). In these text files data is separated by *field delimeters*.

Field Delimiters
: A **field delimeter** is a specific character that's used to separate data values in a text file
