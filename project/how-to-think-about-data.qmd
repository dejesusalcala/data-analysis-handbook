...
Even before any analysis has begun when a data analyst thinks about data in general they will likely view that data in a table format with some visualization of that. 

- - -

Example:
: Suppose we have some data about cars and we want to analyze their horsepower and miles per gallon. An analyst's view of this data should be some scatterplot of the following format   

![](/images/output-images/scatter-plot-1.png){width="85%" fig-align="center"}

Here, each point represents a specific car with its horspower and mpg. Even before any analysis begins, an analyst is likely viewing the relationship between horsepower and mpg in this way.

- - -

## Referring to Variables in Data
...
**Quantitative** data is grouped into two main types; **continuous** and **discrete**. The folllowing are all examples of quantitative data
...
Nominal
: A categorical type of data that represents a group or category that does not have any order or ranking. The following are examples of nominal data
...
Ordinal:
: A categorical type of data that represents a group or category that does have an order or ranking. The following are some examples of ordinal data
